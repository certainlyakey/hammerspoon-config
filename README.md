...
### Invert file selection with a keyboard shortcut

See [`finder.lua`](https://github.com/certainlyakey/hammerspoon-config/blob/main/apps/finder.lua) for usage and [`finder-invert-selection.applescript`](https://github.com/certainlyakey/hammerspoon-config/blob/main/apple-scripts/finder-invert-selection.applescript).
